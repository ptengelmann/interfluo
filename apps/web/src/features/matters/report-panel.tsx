    ...
    <Card>
      ...
      <CardBody className="flex flex-col gap-8">
        <section className="border-l-2 border-accent pl-5">
          ...
          <p className="font-display mt-3 text-[20px] leading-[1.45] text-ink">{report.summary}</p>
        </section>
        ...
        <p className="rounded-md border border-line bg-paper-dim/60 px-4 py-3 text-[12.5px] text-muted leading-relaxed">
          ...
          Generated by Interfluo from the contract pack. Not legal advice. The supervising
          fee-earner remains the responsible professional under the SRA Code of Conduct and must
          review and adopt every assertion before issue. Every accept, edit, and export action on
          this matter is recorded in the Activity tab.
        </p>
      </CardBody>
    </Card>
  );
