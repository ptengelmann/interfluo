...
const ROWS: DocRow[] = [
  ...
  {
    filename: '03-ta6-property-information.pdf',
    type: 'TA6 Property Information',
    pages: 5,
    status: 'done',
  },
  {
    filename: '04-ta7-leasehold-information.pdf',
    type: 'TA7 Leasehold Information',
    pages: 3,
    status: 'done',
  },
  {
    filename: '05-ta10-fittings-and-contents.pdf',
    type: 'TA10 Fittings & Contents',
    pages: 2,
    status: 'done',
  },
  {
    filename: '06-con29-local-authority.pdf',
    type: 'CON29 Local Authority',
    pages: 3,
    status: 'done',
  },
  {
    filename: '07-drainage-and-water-search.pdf',
    type: 'Drainage & Water Search',
    pages: 2,
    status: 'classifying',
  },
];
          ...
          <li key={d.filename} className="flex items-center gap-3.5 px-5 py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11.5px] text-muted">
                {d.pages} pages ·{' '}
                {d.status === 'classifying' ? 'classifying…' : 'classified at 99%'}
              </p>
            </div>
            <span
              className={
