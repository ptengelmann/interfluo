...
const POINTS = [
  ...
  },
  {
    ...
    body: 'A structured library of twenty-one conveyancing issue codes across seven categories, each with a calibrated severity default and named false-positive traps. Validated against six adversarial conveyancing scenarios with an average Matter Quality Score of 99 out of 100. "Critical" actually means deal-blocker.',
  },
  {
    icon: IconRecord,
