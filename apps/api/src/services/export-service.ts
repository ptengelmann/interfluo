    ...
    children: [
      new Paragraph({
        ...
        children: [
          new TextRun({
            text:
              'DRAFT — generated by Interfluo from the contract pack. Not legal advice. Requires review and adoption by the supervising fee-earner before issue. The fee-earner is the responsible professional under the SRA Code of Conduct.',
            font: BODY_FONT,
            size: 14,
            color: '736F64',
            italics: true,
